...
public class InteractionTable {
    ...
    public InteractionTable(List<String> subject, List<String> object, List<Integer> sentenceIndex, List<String> type) {
	...
	public InteractionTable subTable(int begin, int end){
		InteractionTable result = new InteractionTable();
