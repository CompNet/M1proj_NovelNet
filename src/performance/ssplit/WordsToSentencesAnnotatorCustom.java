 ...
 */
public class WordsToSentencesAnnotatorCustom implements Annotator  {

  /** A logger for this class */
  private static final Redwood.RedwoodChannels log = Redwood.channels(WordsToSentencesAnnotatorCustom.class);
  ...
  public WordsToSentencesAnnotatorCustom() {
    this(false);
  }


  public WordsToSentencesAnnotatorCustom(Properties properties) {
  ...
  public WordsToSentencesAnnotatorCustom(boolean verbose) {
    this(verbose, false, new WordToSentenceProcessor<>());
  }

  public WordsToSentencesAnnotatorCustom(boolean verbose, String boundaryTokenRegex,
  ...
  private WordsToSentencesAnnotatorCustom(boolean verbose, boolean countLineNumbers,
  ...
  /** Return a WordsToSentencesAnnotatorCustom that splits on newlines (only), which are then deleted.
   ...
   */
  public static WordsToSentencesAnnotatorCustom newlineSplitter(String... nlToken) {
    // this constructor will keep empty lines as empty sentences
    WordToSentenceProcessor<CoreLabel> wts =
            new WordToSentenceProcessor<>(ArrayUtils.asImmutableSet(nlToken));
    return new WordsToSentencesAnnotatorCustom(false, true, wts);
  }


  /** Return a WordsToSentencesAnnotatorCustom that never splits the token stream. You just get one sentence.
   *
   *  @return A WordsToSentenceAnnotator.
   */
  public static WordsToSentencesAnnotatorCustom nonSplitter() {
    WordToSentenceProcessor<CoreLabel> wts = new WordToSentenceProcessor<>(true);
    return new WordsToSentencesAnnotatorCustom(false, false, wts);
  }
  ...
  public void annotateCustom(Annotation annotation, List<List<CoreLabel>> coreLabelsDoc) {
    ...
    if ( ! annotation.containsKey(CoreAnnotations.TokensAnnotation.class)) {
      throw new IllegalArgumentException("WordsToSentencesAnnotatorCustom: unable to find words/tokens in: " + annotation);
    }
