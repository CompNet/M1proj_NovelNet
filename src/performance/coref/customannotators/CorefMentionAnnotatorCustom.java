package performance.coref.customannotators;
...
public class CorefMentionAnnotatorCustom extends TextAnnotationCreator implements Annotator {

  /**
   * A logger for this class
   */
  private static final Redwood.RedwoodChannels log = Redwood.channels(CorefMentionAnnotatorCustom.class);
  ...
  public CorefMentionAnnotatorCustom(Properties props) {
    try {
  ...
  public void annotateCustom(Annotation annotation, List<List<Mention>> customMentions) {
